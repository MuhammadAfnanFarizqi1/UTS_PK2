...
public class IsiForm extends javax.swing.JPanel {
    ...
    private void showData(String key) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Object nama = rs.getString(1);
                Object alamat = rs.getString(2);
                Object no_telp = rs.getString(3);
                Object email = rs.getString(4);
                Object pengembang = rs.getString(5);
                Object tipe_perumahan = rs.getString(6);

                Object[] data = {nama, alamat, no_telp, email, pengembang, tipe_perumahan};
    ...
    private void hapusData(int baris) {
        ...
        try {
            con = Koneksi.configDB();
            st = con.createStatement();
            st.executeUpdate("DELETE FROM tb_form WHERE id_perumahan=" + baris);
            st.close();
            con.close();
            resetView();
    ...
    private void initComponents() {
        ...
        panelKiri.setBackground(new java.awt.Color(51, 153, 255));
